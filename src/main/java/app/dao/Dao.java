...
public interface Dao<T extends BaseModel> {
	 ...
	 * @return
	 */
	public <T extends BaseModel> List<T> find(String hql, Object[] param, Integer page, Integer rows);
	 ...
	 * @return
	 */
	public <T extends BaseModel> List<T> find(String hql, List<Object> param, Integer page, Integer rows);
